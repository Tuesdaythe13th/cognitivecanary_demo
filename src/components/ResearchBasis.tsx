...
const MODULES = [
  ...
  },
  {
    ...
    richContent: {
      paras: [
        "EEG Foundation Models arrive: DeeperBrain (Wang et al., Jan 2026, arXiv:2601.06134) introduces a neuro-grounded foundation model integrating volume conduction-aware channel encoding and neurodynamics-aware temporal encoding — trained on multi-paradigm EEG corpora via Masked EEG Reconstruction and Neurodynamics Statistics Prediction. Achieves SOTA on both fine-tuning and frozen-probing protocols, effectively replacing task-specific classifiers with a single pre-trained backbone. Implication: a DeeperBrain-class encoder pre-trained on an attacker's corpus would decode identity, emotional state, and intent across sessions with negligible fine-tuning — dramatically raising the floor of passive fingerprinting attacks. Canary v7.1 adversarial training targets this threat class.",
        "Alljoined-1.6M (Xu et al., Aug 2025, arXiv:2508.18571): the first million-trial open EEG-Image dataset acquired on consumer-grade hardware demonstrates log-linear performance scaling — more data = better decoding, even on cheap headsets. NeuroSketch (Zhang et al., Dec 2025, arXiv:2512.09524) follows with systematic architecture optimization achieving SOTA neural decoding across EEG, SEEG, and ECoG on visual, auditory, and speech tasks simultaneously. Together these papers mark the commoditization of neural decoding: an attacker with a consumer EEG device, 1.6M trials, and a NeuroSketch backbone can now construct a credible identity-linking attack. EEG Shield adversarial corpus expanded to include Alljoined-derived samples in v7.1.",
      ...
      citations: [
        "Wang et al. (2026). DeeperBrain: A Neuro-Grounded EEG Foundation Model Towards Universal BCI. arXiv:2601.06134.",
        "Xu et al. (2025). Alljoined-1.6M: A Million-Trial EEG-Image Dataset for Evaluating Affordable Brain-Computer Interfaces. arXiv:2508.18571.",
        "Zhang et al. (2025). NeuroSketch: An Effective Framework for Neural Decoding via Systematic Architectural Optimization. arXiv:2512.09524.",
        "Kumar et al. (2025). A Brain Wave Encodes a Thousand Tokens: Modeling Inter-Cortical Neural Interactions for Effective EEG-based Emotion Recognition. arXiv:2511.13954.",
        "Willett et al. (2024). Brain-to-Text Benchmark '24: Lessons Learned. arXiv:2412.17227.",
  ...
  },
  {
    ...
    richContent: {
      paras: [
        ...
        "Foundation model threat escalation: DeeperBrain-class encoders pre-trained on attacker-controlled corpora collapse the per-user enrollment requirement that previously limited passive fingerprinting attacks. A zero-shot identity-linking attack using a DeeperBrain backbone is now theoretically tractable — and Alljoined-1.6M provides the public pre-training corpus. EEG Shield v7.1 adversarial training must target foundation model embeddings, not just task-specific classifiers. This is the primary new threat surface opened by the 2025–2026 EEG foundation model wave.",
      ...
      openProblems: [
        "Foundation model zero-shot fingerprinting: DeeperBrain + Alljoined-1.6M enables cross-session identity linking without per-user enrollment — EEG Shield must target foundation embeddings",
