...
const milestones = [
  ...
  { version: 'v7.0', date: '2026 Q3', title: 'Neural Adversary', desc: 'GAN-based behavioral synthesis, OS-level driver integration, WebExtension, federated learning attack detection. Three-vector sycophancy decomposition (Vennemeyer et al. ICLR 2026) deployed in Affective Firewall. Channel-embedding multi-agent collusion analysis added to Engine 10.', done: false, current: true },
  { version: 'v7.1', date: '2026 Q4', title: 'Adversarial Hardening', desc: 'Adaptive adversary co-evolution benchmarks grounded in Müller et al. (2026) empirical baseline — 61% re-ID recovery confirmed. Red-team retraining loop. Formal ε-δ privacy proofs for behavioral engines. Digraph-aware keystroke jitter. PGD upgrade for EEG Shield via Korhonen et al. diffusion-based augmentation. Peer-reviewed paper submission.', done: false, research: true },
